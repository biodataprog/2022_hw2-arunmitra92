...
TOTALFILECOUNT=`tail -n +2 calfires_2021.csv | wc -l`
...
awk -F, '{print $2}' calfires_2021.csv | tail -n +2 | sort -n | uniq -c

# print out the name of the largest file use the GIS_ACRES and report the number of acres
LARGEST=`awk -F, '{print $13, $6}' calfires_2021.csv | sort -nr | awk '{print $2, $3}' | head -n 1`
LARGESTACRES=`awk -F, '{print $13}' calfires_2021.csv | sort -nr | head -n 1`
YEAR=`awk -F, '{print $13, $6, $2}' calfires_2021.csv | sort -nr | awk '{print $4}' | head -n 1`
